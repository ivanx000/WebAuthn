...
Audit the passforge codebase for W3C WebAuthn spec compliance.

This command matters because passforge is a security library. Every step in the W3C WebAuthn §7.1 and §7.2 algorithms must either be implemented or have an explicit note explaining why it is omitted. Missing steps are vulnerabilities.
